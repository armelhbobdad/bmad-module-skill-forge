...
What are the best moves for a very long term and robust vision?
...
the /home/armel/Projects/OSS/BMAD-METHOD/package.json has some usefull scripts we don't have yet in @package.json

### Prompt 13

why you did not select install and uninstall?
...
what other improvement can we do in @package.json ? DO NOT HALLUCINATE IF YOU THINK EVERYTHING LOOK OKAY. Do we also need to update @.github/workflows ? FIX ALL PRE-EXISTING COMPLIANCE GAPS

### Prompt 16

Can we validate our skills using npx skill-check and tessl review?

### Prompt 17

No. Move on. since we are skill compliant, we are supposed to be compatible to all IDE that use skill. Make sure the standalone installer also handle all the IDE the same way bmad method did.

### Prompt 18

should we also update @README.md and @docs/ ?

### Prompt 19

Are you sure the @docs/ are reall correct? For example,  all the workflow names, how it works and other pages are still valide?
