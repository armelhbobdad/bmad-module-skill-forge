...
go to party mode more best perspectives
...
Do what is best for a long term support, robust stabillity of SKF
...
The the is to fix SKF, not only the issues provided. Feel free to go beyond the scope. The commits should just well organized at the end and link the ones related to each issue

### Prompt 7

1- Yes
2- "LTS hardening" commit message context is enough
3- the starter set is correct
4- auto-skip for LTS
5- do what is best
