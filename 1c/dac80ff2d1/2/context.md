...
Execute the story-automator review workflow for story 4.12.
...
Story file: _bmad-output/implementation-artifacts/4-12-*.md
Review implementation, find issues, fix them automatically. auto-fix all...
