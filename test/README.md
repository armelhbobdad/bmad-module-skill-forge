...
- **Installation Components** (`test/test-installation-components.js`) — Module config, agent structure, path references, and step-file chain validation for all 14 workflows (including VS, RA, and compose-mode)
